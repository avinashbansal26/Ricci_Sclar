...
%% Diagonal Component Method
[dc1,dc2,dc3]=Diagonal_Component(D);
Diag_Sum=dc1+dc2+dc3;
PD_dc1=Principal_Direction(dc1);
PD_dc2=Principal_Direction(dc2);
PD_dc3=Principal_Direction(dc3);
...
%         for ii=1:3
%                 F(:,:,ii)=double(F_metric (TD(1),TD(2),TD(3),TD(4),TD(5),TD(6),TD(7),TD(8),TD(9),TD(10),TD(11),...
...
%             Fin(:,:,i,j,ii)=squeeze(F(:,:,ii));
%         end
%         FSumAll(:,:,i,j)=FSum/max_num;         % Mean of Finsler/ diffusion matrix
%     end
% end
