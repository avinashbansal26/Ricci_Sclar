...
load('RS_Fwd.mat');
% RS_Fwd(x11,x12,x13,x22,x23,x33,xR11,xR12,xR13,xR22,xR23,xR33,xU11,xU12,xU13,xU22,xU23,xU33,...
%      xRU11,xRU12,xRU13,xRU22,xRU23,xRU33,xRR11,xRR12,xRR13,xRR22,xRR23,...
%      xRR33,xUU11,xUU12,xUU13,xUU22,xUU23,xUU33)= Ricci_Scalar_NM_Fwd_var();
...
figure;
for ii=1:max_num   
      plotDTI(squeeze(Fin(:,:,1:size(D,2),1:size(D,3),ii)),12);    
end
...
for x=1:size(D,2)-2
    for y=1:size(D,3)-2
        ...
        Ricci_Sclar(x,y)=double(RS_Fwd(x11,x12,x13,x22,x23,x33,xR11,xR12,xR13,xR22,xR23,xR33,xU11,xU12,xU13,xU22,xU23,xU33,...
            xRU11,xRU12,xRU13,xRU22,xRU23,xRU33,xRR11,xRR12,xRR13,xRR22,xRR23,...
            xRR33,xUU11,xUU12,xUU13,xUU22,xUU23,xUU33));
...
Ric_Sclr(:,:,ii)=Ricci_Sclar;
 end
Ric_Sclr_Sum=zeros(size(D,2)-2, size(D,3)-2);
for ii=1:max_num
